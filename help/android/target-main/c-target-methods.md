...
* **loadRequest**
   ...
   * Di seguito è riportato un codice di esempio per questo metodo:
      ...
      Per ulteriori informazioni sull&#39;API Target sottostante, consulta [Caricare richieste Target](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-target/target-api-reference-deprecated#load-target-requests) nel riferimento API di Target.
