...
>[!IMPORTANT]
>
>Le informazioni in questo argomento rappresentano un suggerimento per una possibile implementazione. Si consiglia vivamente di rivedere la documentazione di iOS Apple per stabilire la migliore implementazione per l'app. La tua implementazione deve essere determinata dai framework in uso e dalle versioni di iOS che l'app dovrà destinare.
...
* Aggiungi la libreria al progetto e implementa le metriche del ciclo di vita.
...
1. Per determinare le impostazioni per le quali l'app richiede l'autorizzazione, consulta [Configurazione del supporto per le notifiche remote](https://developer.apple.com/library/content/documentation/NetworkingInternet/Conceptual/RemoteNotificationsPG/HandlingRemoteNotifications.html#//apple_ref/doc/uid/TP40008194-CH6-SW1).

   Di seguito è riportato un esempio di implementazione possibile che richiede l'autorizzazione per utilizzare Avvisi, Badge, Suoni e Notifiche remote:
...
1. Per determinare l'implementazione corretta per l'ambiente, vai a [usernotifications](https://developer.apple.com/documentation/usernotifications).
