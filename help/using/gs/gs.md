...
Per maggiori informazioni sui test e su Adobe Target, vai a [Adobe Target](https://docs.adobe.com/content/help/en/target/using/target-home.html).
...
* [Posizione nella guida dell'utente di Mobile Services](/help/using/location/c-location-overview.md)
