...
La funzione *Coinvolgi* offre le seguenti caratteristiche principali:
...
Per ulteriori informazioni sui test e su Adobe Target, consulta la [Adobe Target](https://docs.adobe.com/content/help/it-IT/experience-cloud/user-guides/home.translate.html) documentazione.
...
Per maggiori informazioni sugli SDK di Adobe Mobile, consulta [SDK 4.x per Android per le soluzioni Experience Cloud](/help/android/overview.md) e [SDK 4.x per iOS per le soluzioni Experience Cloud](/help/ios/overview.md).
