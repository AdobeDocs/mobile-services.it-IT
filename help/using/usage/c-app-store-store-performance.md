...
Fai clic su una metrica per nascondere o visualizzare la riga corrispondente. Passa il cursore sopra una data per visualizzare i dati di quel giorno.
...
You can click anywhere on the **[!UICONTROL App Store Average Rating]** widget to display a graph and chart that displays the average rating by date. Passa il cursore sopra una data per visualizzare i dati di quel giorno.
...
Per visualizzare un grafico con diagramma che mostra il numero di download per paese e per data, fai clic su **[!UICONTROL Download per paese]**. Puoi passare il cursore sopra una data per visualizzare i dati di quel giorno.
