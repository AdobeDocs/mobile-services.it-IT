...
Quando apri il rapporto **[!UICONTROL Funnel], devi creare un funnel personalizzato.** Per ulteriori informazioni, consultate [Personalizzare i rapporti](/help/using/usage/reports-customize/reports-customize.md).
