...
Per gestire i messaggi, fai clic su ***your_app_name*** &gt; **[!UICONTROL Messaggistica]** &gt; **[!UICONTROL Gestire i messaggi]**.
...
* **Cercare e filtrare messaggi**
   ...
   Usa la casella di ricerca nella parte superiore dell’elenco per cercare e filtrare i messaggi. Quando inserisci un testo nella casella di ricerca, vengono visualizzati i messaggi dell’elenco corrispondenti a quel testo. La ricerca ha effetto su tutte le colonne della tabella. Ad esempio, puoi digitare  `Draft`per visualizzare solo i messaggi che sono nello stato di bozza, oppure puoi immettere il nome di un utente per mostrare solo i messaggi che sono stati aggiornati da quell’utente.
