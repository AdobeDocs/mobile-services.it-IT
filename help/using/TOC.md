...
+ Getting started {#get-started-ug}
   ...
   + [Tipi di report](gs/reports-types.md)
   + Mobile metrics {#mobile-metrics}
      + [Metriche mobili](gs/metrics/metrics.md)
      + [Visualizzare le metriche relative ai dispositivi mobili](gs/metrics/overview.md)
      + [Riferimento per metriche e dimensioni per dispositivi mobili](gs/metrics/metrics-reference.md)
+ Manage apps {#manage-apps-ug}
   ...
   + App store {#app-store}
      ...
      + [Aggiunta di un'app da un app store](manage-apps/c-app-store/t-app-store-app.md)
      + [Eliminare un'app](manage-apps/t-delete-apps.md)
+ Manage app settings {#manage-app-settings-ug}
   + [Gestione delle impostazioni dell'app](c-manage-app-settings/c-manage-app-settings.md)
   + Configuring your app {#configuring-app}
      ...
      + [Download di SDK e strumenti per dispositivi mobili](c-manage-app-settings/c-mob-confg-app/t-config-analytics/download-sdk.md)
      ...
      + [Configurare l'app per l'utilizzo di APNS o FCM](c-manage-app-settings/c-mob-confg-app/configure-push-messaging/configure-app-apns-gcm.md)
   + [Gestione dell'app](c-manage-app-settings/c-mob-manage-app.md)
+ Rapporti {#reports-ug}
   + [Panoramica dei report](usage/usage.md)
   + [Report Panoramica](usage/usage-overview.md)
   ...
   + [Rapporto sulla tecnologia](usage/reports-technology.md)
   + [Arresti anomali, rapporto](usage/c-crashes.md)
...
+ Utilizzo dei rapporti {#work-with-reports-ug}
   ...
   + [Aggiunta di filtri ai rapporti](usage/reports-customize/t-reports-customize.md)
...
+ Acquisizione {#acquisition-main-ug}
   ...
   + Create and manage link destinations {#create-manage-link-destination}
      ...
      + Legacy Acquisition links {#legacy-acquisition-links}
         ...
         + [Gestione dei collegamenti di acquisizione](acquisition-main/c-marketing-links-builder/t-create-edit-adobe-links/c-use-legacy-acquisition-links/c-manage-acquisition-links/c-manage-acquisition-links.md)
         ...
         + [Importare o esportare i collegamenti di acquisizione](acquisition-main/c-marketing-links-builder/t-create-edit-adobe-links/c-use-legacy-acquisition-links/c-manage-acquisition-links/t-acquisition-import.md)
...
+ Posizione {#location-ug}
   ...
   + [Gestione dei punti di interesse](location/t-manage-points.md)
+ Messaggistica {#messaging-ug}
   ...
   + Messaggi in-app {#inapp-messages}
      ...
      + [Attiva un messaggio in-app quando l'app viene aperta da un messaggio push](in-app-messaging/t-mob-trig-in-app-open-app-from-push.md)
